...
public class Evcplus {
    public static void main(String[] args) {
        ...
        // Xaqiijinta in dial-ama-Garaaca ku uu sax yahay
        ...
        if (dial.equals(dial2)){
            ...
            if (pin==pin2){
                ...
                switch (num){
                    ...
                    case 2:
                        ...
                        System.out.println("Fadlan gali pinkaga");

                        // Confirm PIN | Hubinta Biinka
                        int comfirmPin=input.nextInt();

                        if (comfirmPin!=pin) {
                            System.out.println("Fadlan iska sax numberka sirta ah");
                        ...
                        if (dooronumber == 1) {
                            ...
                            if (amount <= haraa) {
                                haraa -= amount;
                                System.out.println("Waxaad si guul leh ugu shubtay $" + amount + " Airtime.");
            ...
            System.out.println("Soo gali dial sax ah");
        }
